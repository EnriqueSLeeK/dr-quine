...
int main(){
  ...
  name[0] = '.';
  name[1] = '/';
  fprintf(fo, S, 10, 10, 10, 10, 10, 34, 34, 10, COUNT - 1, 10, 34, S, 34, 10, 34, 37, 37, 34, 10, 10, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 34, 10);
  fclose(fo);
  int pid = fork();
  if (pid == 0){
    char *a[]={"gcc", "-Wextra", "-Werror", "-Wall", dup, "-o", name, NULL};
